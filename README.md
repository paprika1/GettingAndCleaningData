...
## Running the Scripts and Producing Output

Files are located in the GettingAndCleaningData GitHub repository indicated above

1. Open the run_analysis.R script using RStudio
2.  
